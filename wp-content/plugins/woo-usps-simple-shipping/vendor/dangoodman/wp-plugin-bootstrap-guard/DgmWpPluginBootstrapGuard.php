...
class Dgm_UspsSimple_Vendors_DgmWpPluginBootstrapGuard
{
    /**
    ...
    private function checkAndBoot()
    {
        ...
        if (!class_exists('Dgm_UspsSimple_Vendors_DgmWpDismissibleNotices')) {
            require_once(__DIR__.'/DgmWpDismissibleNotices.php');
        }

        if (!Dgm_UspsSimple_Vendors_DgmWpDismissibleNotices::isNoticeDismissed($noticeId = 'dgm-zend-guard-loader')) {
        ...
        if ($this->warnings) {
            Dgm_UspsSimple_Vendors_DgmWpDismissibleNotices::init();
        }
    }
