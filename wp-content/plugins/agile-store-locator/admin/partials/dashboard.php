  ...
  <div class="asl-inner-dashboard">
    ...
    <div class="asl-analytics-sec">
      ...
      <div class="tab-content" id="asl-tabs">
        <div class="row asl-form-box">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <a title="<?php echo esc_attr__('Export Analytics','asl_locator') ?>" id="sl-btn-export-stats" class="asl-Upload-icon disabled" style="opacity: 0.4;cursor: default;">
        ...
        <div class="tab-pane active asl-lock-box" role="tabpanel" id="asl-analytics" aria-labelledby="asl-analytics">
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="asl-lock-inner">
                ...
                <a href="https://codecanyon.net/item/agile-store-locator-google-maps-for-wordpress/16973546"><?php echo esc_attr__('Lifetime License - $34','asl_locator') ?></a>
              </div>
            </div>
          </div>
        </div>
              ...
              <ul class="list-group" id="asl-stores-views">
                <li>
                  <div class="col-12 text-center font-weight-bold">
                    <p><?php echo esc_attr__('Pro version only','asl_locator') ?></p>
                  </div>
                </li>
              </ul>
            </div>
    ...
    <div class="asl-feature-sec sl-complx">
      ...
      <div class="row">
        <a class="col-lg-3 col-md-6 col-sm-6" target="_blank" href="https://agilestorelocator.com/demos/">
          <div class="asl-feature-box asl-lock-box">
            <h3><?php echo esc_attr__('Store Locator Templates','asl_locator') ?></h3>
        ...
        <a class="col-lg-3 col-md-6 col-sm-6" target="_blank" href="https://agilestorelocator.com/search-widget/">
          <div class="asl-feature-box asl-lock-box">
        ...
        <a class="col-lg-3 col-md-6 col-sm-6" target="_blank" href="https://agilestorelocator.com/store-register-form/">
          <div class="asl-feature-box asl-lock-box">
    ...
    <div class="asl-benefits-sec mt-3">
      <div class="asl-top-title">
        <span class="asl-lines"></span>
          ...
          <div class="asl-benefits-ctn-box">
            <div class="position-relative" style="z-index: 1;">
              ...
              <ul>
                ...
                <li><?php echo esc_attr__('Unlock 100+ Advanced Locator Options','asl_locator') ?></li>
                <li><?php echo esc_attr__('CSV Import & Export All your Stores','asl_locator') ?></li>
                <li><?php echo esc_attr__('Advance Data Filtering Controls Option','asl_locator') ?></li>
              ...
              <a href="https://codecanyon.net/item/agile-store-locator-google-maps-for-wordpress/16973546"><?php echo esc_attr__('Get Lifetime License - $34','asl_locator') ?></a>
            </div>
    ...
    <div class="asl-basic-info-sec mt-3 sl-complx">
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          <div class="asl-right-box asl-lock-box">
            <div class="asl-head">
              <h4><?php echo esc_attr__('Backup Template','asl_locator') ?></h4>
              <a id="sl-btn-tmpl-remove" style="opacity: 0.4"><?php echo esc_attr__('Delete Template','asl_locator') ?></a>
            </div>
            <div class="row">
              <div class="col-md-3 col-sm-3 col-6">
                <a id="sl-btn-tmpl-backup" class="asl-backup-tmpl-box" style="opacity: 0.4;cursor: default;">
