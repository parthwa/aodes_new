        ...
        <div class="card p-0 mb-4">
          ...
          <div class="card-body">
            <?php if(!is_writable(ASL_PLUGIN_PATH.'public/icon')): ?>
              <h3  class="alert alert-danger" style="font-size: 14px"><?php echo ASL_PLUGIN_PATH.'public/icon' ?> <= <?php echo esc_attr__('Directory is not writable, Logo Image Upload will Fail, Make directory writable.','asl_locator') ?></h3>  
            <?php endif; ?>
            <div class="row mb-4">
              <div class="col-md-12 ralign">
                ...
                <button type="button" id="btn-asl-new-c" class="btn disabled btn-primary mrg-r-10"><i><svg width="13" height="13"><use xlink:href="#i-plus"></use></svg></i><?php echo esc_attr__('New Logo','asl_locator') ?></button>
              </div>
            </div>
      ...
      <div class="smodal-content">
        ...
        <div class="smodal-body">
          ...
          <div class="smodal-footer">
            <button class="btn disabled btn-primary btn-start mrg-r-15" id="btn-asl-update-logos"   type="button" data-loading-text="<?php echo esc_attr__('Submitting ...','asl_locator') ?>"><?php echo esc_attr__('Update Logo','asl_locator') ?></button>
  ...
  <div class="smodal-dialog" role="document">
      <div class="smodal-content">
          ...
          <div class="row">
            ...
            <div class="col-md-12 form-group mb-3" id="drop-zone">
              <div class="input-group">
                <div class="input-group-prepend">
                  <span class="input-group-text"><?php echo esc_attr__('Logo','asl_locator') ?></span>
                </div>
                <div class="custom-file">
        ...
        <div class="smodal-footer">
          ...
          <button type="button" class="btn disabled btn-secondary" data-dismiss="smodal"><?php echo esc_attr__('Close','asl_locator') ?></button>
        </div>
        </form>
      </div>
    </div>
