    ...
    <div class="row asl-inner-cont">
      <div class="col-md-12">
        <div class="card p-0 mb-4">
          <h3 class="card-title"><?php echo esc_attr__('Import Stores (Pro Version)','asl_locator') ?></h3>
          <div class="card-body">
                ...
                <div class="asl-google-api-key asl-import-stores-box mb-4">
                  ...
                  <div class="input-group">
                    ...
                    <div class="input-group-append">
                      <a id="btn-validate-key" data-loading-text="<?php echo esc_attr__('Validating...','asl_locator') ?>" class="btn disabled btn-sm btn-primary"><?php echo esc_attr__('Validate Key','asl_locator') ?></a>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="sl-complx asl-fatch-coordinates asl-import-stores-box mb-4">
                  ...
                  <a data-loading-text="<?php echo esc_attr__('Fetching Coordinates...','asl_locator') ?>" id="btn-fetch-miss-coords" class="btn disabled btn-sm btn-primary"><?php echo esc_attr__('Fetch Missing Coordinates','asl_locator') ?></a>
                </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="row">
                  <div class="col-md-6 mb-3">
                    <div class="float-md-left">
                      <button type="button" class="btn disabled btn-success mr-2" data-toggle="smodal" data-target="#import_store_file_emodel"><i><svg width="13" height="13"><use xlink:href="#i-upload"></use></svg></i><?php echo esc_attr__('Upload','asl_locator') ?></button>
                      <a href="<?php echo admin_url( 'admin-ajax.php' ).'?action=asl_ajax_handler&sl-action=export_file' ?>" class="btn disabled btn-success mr-2" id="export_store_file_"><i><svg width="13" height="13"><use xlink:href="#i-export"></use></svg></i><?php echo esc_attr__('Export All','asl_locator') ?></a>
                      <a target="_blank" class="btn disabled btn-dark" href="<?php echo ASL_URL_PATH.'public/export/template-import.csv' ?>">Template.csv</a>         
                    </div>
                  </div>
                  <div class="col-md-6 mb-3">
                    <div class="float-md-right">
                      <button type="button" class="btn disabled btn-danger mr-2" data-loading-text="<?php echo esc_attr__('Deleting...','asl_locator') ?>" id="asl-delete-stores"><i><svg width="13" height="13"><use xlink:href="#i-trash"></use></svg></i><?php echo esc_attr__('Delete All Stores','asl_locator') ?></button>
                      <button type="button" class="sl-complx btn disabled btn-warning mr-2" data-loading-text="<?php echo esc_attr__('Removing...','asl_locator') ?>" id="asl-duplicate-remove"><i><svg width="13" height="13"><use xlink:href="#i-trash"></use></svg></i><?php echo esc_attr__('Remove Duplicates','asl_locator') ?></button>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="row mt-3">
                      <div class="col-lg-6 mb-2">
                        <div class="form-group mb-1 sl-complx">
      ...
      <div class="smodal-content">
        ...
        <div class="smodal-body">
          <form id="import_store_file" name="import_store_file">
            <div class="col-md-12 form-group mb-3">
              <div class="input-group" id="drop-zone">
                ...
                <div class="custom-file">
                 <input type="file" class="btn disabled btn-default" accept=".csv" style="width:98%;opacity:0;position:absolute;top:0;left:0"  name="files" id="file-logo-1" />
            ...
            <div class="col-md-12 form-group mb-3">
              <button class="btn disabled btn-primary float-right btn-start" type="button" data-loading-text="Submitting ..."><?php echo esc_attr__('Upload File','asl_locator') ?></button>
            </div>
          </form>
        </div>
      </div>
