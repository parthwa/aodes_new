...
namespace UpsFreeVendor\WPDesk\Forms\Form;

use Psr\Container\ContainerInterface;
use UpsFreeVendor\WPDesk\Forms\ContainerForm;
use UpsFreeVendor\WPDesk\Forms\Field;
use UpsFreeVendor\WPDesk\Forms\FieldProvider;
use UpsFreeVendor\WPDesk\Forms\Form;
...
class FormWithFields implements \UpsFreeVendor\WPDesk\Forms\Form, \UpsFreeVendor\WPDesk\Forms\ContainerForm, \UpsFreeVendor\WPDesk\Forms\FieldProvider
{
    ...
    /** @return void */
    public function add_field(\UpsFreeVendor\WPDesk\Forms\Field $field)
    {
        $this->fields[] = $field;
    }
     ...
     * @return void
     */
    public function set_data(\Psr\Container\ContainerInterface $data)
    {
        foreach ($this->fields as $field) {
            $data_key = $field->get_name();
            if ($data->has($data_key)) {
                ...
                } catch (\UpsFreeVendor\WPDesk\Persistence\ElementNotExistsException $e) {
    ...
    public function render_fields(\UpsFreeVendor\WPDesk\View\Renderer\Renderer $renderer) : string
    {
        $content = '';
    ...
    public function render_form(\UpsFreeVendor\WPDesk\View\Renderer\Renderer $renderer) : string
    {
    ...
    {
        $fields = $this->fields;
        \usort($fields, static function (\UpsFreeVendor\WPDesk\Forms\Field $a, \UpsFreeVendor\WPDesk\Forms\Field $b) {
