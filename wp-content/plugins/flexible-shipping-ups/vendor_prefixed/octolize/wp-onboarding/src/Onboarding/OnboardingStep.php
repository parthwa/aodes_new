...
class OnboardingStep implements \JsonSerializable
{
     ...
     */
    public function set_id(string $id) : \UpsFreeVendor\Octolize\Onboarding\OnboardingStep
    {
        $this->id = $id;
        return $this;
    }
     ...
     * @return OnboardingStep
     */
    public function set_step(int $step) : \UpsFreeVendor\Octolize\Onboarding\OnboardingStep
    {
        $this->step = $step;
        return $this;
    }
     ...
     * @return OnboardingStep
     */
    public function set_logo(bool $logo) : \UpsFreeVendor\Octolize\Onboarding\OnboardingStep
    {
        $this->logo = $logo;
        return $this;
    }
     ...
     * @return OnboardingStep
     */
    public function set_title(string $title) : \UpsFreeVendor\Octolize\Onboarding\OnboardingStep
    {
        $this->title = $title;
        return $this;
    }
     ...
     * @return OnboardingStep
     */
    public function set_show(bool $show) : \UpsFreeVendor\Octolize\Onboarding\OnboardingStep
    {
        $this->show = $show;
        return $this;
    }
     ...
     * @return OnboardingStep
     */
    public function set_image(string $image) : \UpsFreeVendor\Octolize\Onboarding\OnboardingStep
    {
        $this->image = $image;
        return $this;
    }
     ...
     * @return OnboardingStep
     */
    public function set_heading(string $heading) : \UpsFreeVendor\Octolize\Onboarding\OnboardingStep
    {
     ...
     * @return OnboardingStep
     */
    public function set_sub_heading(string $sub_heading) : \UpsFreeVendor\Octolize\Onboarding\OnboardingStep
    {
     ...
     * @return OnboardingStep
     */
    public function set_buttons(array $buttons) : \UpsFreeVendor\Octolize\Onboarding\OnboardingStep
    {
        $this->buttons = $buttons;
        return $this;
    }
     ...
     * @return OnboardingStep
     */
    public function set_content(array $content) : \UpsFreeVendor\Octolize\Onboarding\OnboardingStep
    {
        $this->content = $content;
        return $this;
    }
    ...
    private function serializeContent() : array
    {
        ...
        foreach ($this->content as $field) {
            ...
            if ($field instanceof \UpsFreeVendor\WPDesk\Forms\Field\CheckboxField) {
