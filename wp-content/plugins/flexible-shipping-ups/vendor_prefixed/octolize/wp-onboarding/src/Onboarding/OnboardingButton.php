...
class OnboardingButton implements \JsonSerializable
{
     ...
     */
    public function set_label(string $label) : \UpsFreeVendor\Octolize\Onboarding\OnboardingButton
    {
        $this->label = $label;
        return $this;
    }
     ...
     * @return OnboardingButton
     */
    public function set_type(string $type) : \UpsFreeVendor\Octolize\Onboarding\OnboardingButton
    {
        $this->type = $type;
        return $this;
    }
     ...
     * @return OnboardingButton
     */
    public function set_popup(string $popup) : \UpsFreeVendor\Octolize\Onboarding\OnboardingButton
    {
        $this->popup = $popup;
        return $this;
    }
     ...
     * @return OnboardingButton
     */
    public function set_classes(string $classes) : \UpsFreeVendor\Octolize\Onboarding\OnboardingButton
    {
