	...
	?>
		<div class="ocdi__demo-import-notice  js-ocdi-demo-import-notice">
			...
			<ul>
				...
				?>
					<li>
						<a target="_blank" class="syst-link" href="https://smartdatasoft.com/smart_doc_template/server-requirements/?utm_source=demo_importer&utm_medium=thm_di&utm_campaign=importer_page">
							<?php
							echo esc_html__('Recommended PHP configuration', 'pt-ocdi');
							?>
						</a>
