...
trait SettingsTrait
{
    ...
    public function generate_settings_html($form_fields = array(), $echo = \true)
    {
        ...
        $settings = new \FedExVendor\WPDesk\AbstractShipping\Settings\SettingsValuesAsArray(\array_merge($this->settings, $this->instance_settings));
        $html = '';
    ...
    private function prepare_custom_field_types($fields)
    {
        ...
        if ($this instanceof \FedExVendor\WPDesk\WooCommerceShipping\ShippingMethod\HasCustomOrigin) {
            $custom_origin_fields = new \FedExVendor\WPDesk\WooCommerceShipping\CustomOrigin\CustomOriginFields();
