...
$blog_single_social = brator_get_options( 'blog_single_social' );
...
<div class="brator-blog-single-post-content-area">
	...
	<div class="brator-blog-single-post-fe-img"><?php the_post_thumbnail( 'full' ); ?></div>
	<?php endif; ?>
</div>
...
<?php do_action( 'brator_related_products' ); ?>
<?php if ( has_tag() ) { ?>
<div class="blog-single-tag-share-area">
	<div class="blog-single-tag-area">
		<?php brator_tag_list(); ?>
	</div>
	<?php if ( $blog_single_social == '1' ) : ?>
	<div class="blog-single-social-area">
		<p><?php esc_html_e( 'share', 'brator' ); ?></p>
		<?php do_action( 'brator_blog_social' ); ?>
	</div>
	<?php endif; ?>
</div>
	<?php
}
do_action( 'brator_authore_box' );
do_action( 'brator_posts_nav' );
do_action( 'brator_related_posts' );
