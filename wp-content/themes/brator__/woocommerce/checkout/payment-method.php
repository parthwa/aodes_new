...
<div class="form-group wc_payment_method payment_method_<?php echo esc_attr( $gateway->id ); ?>">
	<input id="payment_method_<?php echo esc_attr( $gateway->id ); ?>" type="radio" class="input-radio radio_group"
	...
	<label for="payment_method_<?php echo esc_attr( $gateway->id ); ?>">
		...
		<?php echo wp_kses( $gateway->get_icon(), 'code_contxt' ); /* phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped */ ?>
	</label>
