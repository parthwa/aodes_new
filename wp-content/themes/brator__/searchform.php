...
<form role="search" method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	<input class="search-field" type="search" id="<?php echo esc_attr( uniqid( 'search-form-' ) ); ?>" placeholder="<?php esc_attr_e( 'Search...', 'brator' ); ?>" value="<?php echo get_search_query(); ?>" name="s" required="">
	<button type="submit">
